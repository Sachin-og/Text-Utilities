...
export default function About(props) {
    const [func,setfunc] = useState("Enable");
    let myStyle2 = {
        color : 'white',
  ...
  <button type = "button" className={`btn btn-${props.mode==='light'?'light':(props.mode==='#021057'?'primary':(props.mode==='#a90000'?'danger':'success'))} my-3 mx-2`} onClick={handleDarkMode}>{func} Dark Mode</button>
  </div>
    </div>
  )
}
